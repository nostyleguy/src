...
TcpConnection::TcpConnection(TcpManager *tcpManager, TcpBlockAllocator *sendAlloc, TcpManager::TcpParams &params, const IPAddress &destIP, uint16_t destPort, unsigned timeout)
...
TcpConnection::TcpConnection(TcpManager *tcpManager, TcpBlockAllocator *sendAlloc, TcpManager::TcpParams &params, SOCKET socket, const IPAddress &destIP, uint16_t destPort)
: m_nextConnection(nullptr),
  m_prevConnection(nullptr),
  m_socket(socket),
  m_nextKeepAliveConnection(nullptr),
